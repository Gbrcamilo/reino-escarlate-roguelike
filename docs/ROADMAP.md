...
- [ ] Adicionar câmera, tremor configurável e telegráfos.
- [ ] Adicionar pausa, controles e configurações.
- [ ] Fazer testes de teclado, mouse e gamepad.
- [ ] Balancear duração de run e recompensas.

## Marco 5 — Publicação
- [ ] Configurar GitHub Actions para build/deploy.
- [ ] Habilitar GitHub Pages no repositório.
- [ ] Publicar uma versão jogável.
- [ ] Registrar bugs e próximos biomas como GitHub Issues.
